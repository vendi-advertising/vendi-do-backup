...
openssl rand 64 | tee >(openssl enc -aes-256-cbc -pass stdin -in $gz_file -out $gz_file.enc) | openssl rsautl -encrypt -pubin -inkey /vbin/ENCRYPTION_KEY_HERE -out $gz_file.enc.key
