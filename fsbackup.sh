...
openssl rand 64 | tee >(openssl enc -aes-256-cbc -pass stdin -md sha512 -pbkdf2 -iter 1000 -in "$archive_file" -out "$archive_file.enc") | openssl rsautl -encrypt -pubin -inkey /vbin/ENCRYPTION_KEY_HERE -out "$archive_file.enc.key"
